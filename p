...
ulang:
// function change(){
echo color("blue","                     WELCOME Ilyana\n");
echo color("red","                             \n");
echo color("green","                  Format nomor 62*** \n");
        $nama = nama();
        ...
        $data = '{"email":"'.$email.'@yahcko.co.id","name":"'.$nama.'","phone":"+'.$hp.'","signed_up_country":"ID"}';
	...
	$post = [
 		'chat_id' => $chatid,
                ...
                "User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.2704.84 Safari/436.36" 
                        ];
                                        $ch = curl_init();
         ...
         echo color("white","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN BARU = 242499 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"242499"}';
         ...
         echo color("red","-] NOMOR TERDAFTAR");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
